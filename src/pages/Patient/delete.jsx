...
import {
  Upload, FileText, Eye, Trash2, Heart, Shield,
   X, Image as ImageIcon, AlertCircle, CheckCircle, Clock, Brain, Zap, BarChart3, FileStack, TrendingUp
} from 'lucide-react';
                  ...
                  {overallInsights ? (
                    <div className="p-4 bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg border border-purple-200">
                      <div className="flex items-center space-x-2 mb-3">
                        ...
                        <h3 className="font-medium text-purple-800">Overall Health Analysis</h3>
                      ...
                      <div className="mt-2 text-xs text-gray-500">
                        Generated: {new Date(overallInsights.timestamp).toLocaleString()}
                      </div>
                    </div>
                  ) : reportHistory.length === 0 ? (
                      ...
                      <div key={insight.id} className="border rounded-lg p-4 hover:bg-gray-50">
                        ...
                        <div className="space-y-2">
                          {insight.insights.map((text, index) => (
                            <p key={index} className="text-sm text-gray-600 p-2 bg-purple-50 rounded">
                              {text}
                            </p>
                          ))}
                        </div>
